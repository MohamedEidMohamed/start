            ...
            <div class="content">
                <form method="post" action="{{Route('store')}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name_ar" name="name_ar" aria-describedby="name" placeholder="Enter name of order ar">
                    </div>
                    <div class="form-group">
                        <label >name of order</label>
                        <input type="text" class="form-control" id="name_en" name="name_en" aria-describedby="name" placeholder="Enter name of order eng">
                    </div>
                    <div class="form-group">
